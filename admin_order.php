        ...
        <table class="table table">
            ...
            <thead>
                <tr>
                    ...
                    <th style="width: 70px;">ราคารวม</th>
                        ...
                        if ($row['cart_no'] !== $previous_cart_no) {
                            ...
                            <form id="uploadForm" action="upload_image_slip.php" method="post" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-select" name="status_delivery"
                                            onchange="updateStatus(this.value, <?php echo $row['order_id']; ?>)">
                                            <option value="1" <?php if ($row['status_delivery'] == 1)
                                                echo 'selected'; ?>>
                                                ชำระเงินเสร็จสิ้น รอการยืนยัน</option>
                                            <option value="2" <?php if ($row['status_delivery'] == 2)
                                                echo 'selected'; ?>>ยืนยันสำเร็จ
                                                กำลังจัดส่ง</option>
                                            <option value="3" <?php if ($row['status_delivery'] == 3)
                                                echo 'selected'; ?>>จัดส่งสำเร็จ
                                            </option>
                                            <option value="4" <?php if ($row['status_delivery'] == 4)
                                                echo 'selected'; ?>>
                                                ขอยกเลิกรายการ</option>
                                            <option value="5" <?php if ($row['status_delivery'] == 5)
                                                echo 'selected'; ?>>
                                                ยกเลิกรายการสำเร็จ</option>
                                            <option value="6" <?php if ($row['status_delivery'] == 6)
                                                echo 'selected'; ?>>
                                                ยกเลิกรายการล้มเหลว</option>
                                        </select>
                                    </td>
                                    <td>
