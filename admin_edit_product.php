                    ...
                    <div class="container text-center pt-5">
                        <div class="card form-floating d-inline-block" style="width: 45%">
                            <input type="text" class="form-control" name="employee_id"
                                value="<?php echo $row['employee_id']; ?>" readonly>
                        ...
                        <div class="card form-floating d-inline-block" style="width: 45%">
                            <select class="form-select" name="category_id">
                                <option value="1" <?php if ($row['category_id'] == 1)
                                    echo 'selected'; ?>>Monitor</option>
                                <option value="2" <?php if ($row['category_id'] == 2)
                                    echo 'selected'; ?>>CPU</option>
                                <option value="3" <?php if ($row['category_id'] == 3)
                                    echo 'selected'; ?>>Mainboard</option>
                                <option value="4" <?php if ($row['category_id'] == 4)
                                    echo 'selected'; ?>>Graphic card</option>
                                <option value="5" <?php if ($row['category_id'] == 5)
                                    echo 'selected'; ?>>RAM</option>
                                <option value="6" <?php if ($row['category_id'] == 6)
                                    echo 'selected'; ?>>Power Supply</option>
                                <option value="7" <?php if ($row['category_id'] == 7)
                                    echo 'selected'; ?>>HDD&SSD</option>
                                <option value="8" <?php if ($row['category_id'] == 8)
                                    echo 'selected'; ?>>Cooling Fan</option>
                                <option value="9" <?php if ($row['category_id'] == 9)
                                    echo 'selected'; ?>>Accessories</option>
                            </select>
