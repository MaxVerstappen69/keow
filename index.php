...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide w3-animate-bottom" data-bs-ride="carousel" style="">
        ...
        <div class="carousel-inner ">
            <div class="carousel-item active">
                <img src="image/computer1.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="image/computer2.png" class="d-block w-100 h-50" alt="...">
            </div>
            <div class="carousel-item">
                <img src="image/computer3.png" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <div class="container w3-animate-bottom shadow"
        ...
        <div class="pic" style="text-align: center; display: flex; justify-content: center;">
            ...
            <a href="powersupply.php" class="icon text-decoration-none text-dark"
                style="margin-right: 80px; margin-top:auto;">
                <img src="image/powersupply.png" alt="" style="width: 50px; height: 50px;">
                <p>Power Supply</p>
            </a>
                        ...
                        <div class="card h-100 text-center shadow rounded" style="background-color: #B8D8BA;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="productDetail.php?id=<?php echo $row['product_id']; ?>" class="btn fw-bold"
                                    target="_blank" style='background-color: #EF959D'>View Details</a>
