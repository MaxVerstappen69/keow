        ...
        <div class="container d-flex justify-content-between align-items-center">
            <div>
                <a class="navbar-brand" href="index.php">
                    <img src="image/logo.png" width="90" height="70" class="d-inline-block align-top"
                        alt="">
                </a>
            </div>
            ...
            <div class="d-flex justify-content-center py-3">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a href="admin_employee.php" class="nav-link"
                            style="color: black;">พนักงาน</a></li>
                    <li class="nav-item"><a href="admin_order.php" class="nav-link"
                            style="color: black;">รายการสั่งซื้อ</a></li>
                    <li class="nav-item"><a href="admin_product.php" class="nav-link"
